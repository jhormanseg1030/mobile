...
public class ProductController{
    ...
    @PostMapping
    @PreAuthorize("hasAnyRole('ADMIN', 'COORDINADOR')")
    public ResponseEntity<Product> createProduct(@ResquestBody Product product){
    ...
    public ResponseEntity<MessageResponse> deleteProduct(@PathVariable Long id, @RequestBody Product product){
